...
{ private String world[][];
  ...
  private int previousMove = 0; // Inicialmente no hay ningún movimiento previo
  ...
  { this.beginX = beginX; 
    ...
    this.endY = endY;
    world = new String [30][30];
    world[beginX] [beginY] = "B"; world[endX] [endY] = "E";
  }
  ...
  public void up(){ 
    if (previousMove != 1) {
        ...
        // Verifica si la nueva posición coincide con la casilla "end"
        if (currentX == endX && currentY == endY) {
            System.out.println("Has llegado a tu destino (end)"); 
        } else {
  ...
  public void down(){  
    if (previousMove != 3) {
        ...
        // Verifica si la nueva posición coincide con la casilla "end"
        if (currentX == endX && currentY == endY) {
            System.out.println("Has llegado a tu destino (end)"); // Puedes imprimir un mensaje o realizar alguna acción aquí
        } else {
            // Actualiza la posición de "begin" en el mundo
